...
LinkedBoxes.prototype.tickGraph = function () {
  ...
  for (link of this.links) {
    ...
    switch (this.config.linkStyle) {
      case 'straight':
        link.path.setAttribute('d', 'M' + link.srcCircle.x + ',' + link.srcCircle.y + 'L' + link.dstCircle.x + ',' +
          link.dstCircle.y);
        break;
      case 'vertical':
        link.path.setAttribute('d', 'M' + link.srcCircle.x + ',' + link.srcCircle.y + 'C' + link.dstCircle.x + ',' +
          link.srcCircle.y + ' ' + link.srcCircle.x + ',' + link.dstCircle.y + ' ' + link.dstCircle.x + ',' + link.dstCircle
          .y);
        break;
      case 'horizontal':
        link.path.setAttribute('d', 'M' + link.srcCircle.x + ',' + link.srcCircle.y + 'C' + link.srcCircle.x + ',' +
          link.dstCircle.y + ' ' + link.dstCircle.x + ',' + link.srcCircle.y + ' ' + link.dstCircle.x + ',' + link.dstCircle
          .y);
        break;
      case 'hybrid':
      ...
      case 'gravity':
        ...
        link.path.setAttribute('d', 'M' + link.srcCircle.x + ',' + link.srcCircle.y + 'C' + (link.srcCircle.x + diffX *
            0.25) + ',' + maxY + ' ' + (link.srcCircle.x + diffX * 0.75) + ',' + maxY + ' ' + link.dstCircle.x +
          ',' + link.dstCircle.y);
        break;
    }
  }
...
LinkedBoxes.prototype.syncNodeSide = function (width, side, isLeft) {
  for (var i = 0; i < side.length; ++i) {
    ...
    segment.label.setAttribute('x', Math.round((isLeft) ? this.config.nodePadding * 2 : width - this.config.nodePadding *
      2));
...
module.exports.LinkedBoxes = LinkedBoxes;
